  ...
  return (
    <div style={{ position: "relative" }}>
      <button onClick={() => setShowDropdown(!showDropdown)} style={{ fontSize: '35px' }}>
        🔔
        {unreadCount > 0 && (
          <span style={{ color: "red", fontWeight: "bold" }}>{unreadCount}</span>
        )}
      </button>
    ...
    {showDropdown && (
        <div style={{
            ...
            <div
                ...
                onMouseEnter={e => {
                (e.currentTarget as HTMLElement).style.backgroundColor = "#e6f2ff";
                }}
                onMouseLeave={e => {
                (e.currentTarget as HTMLElement).style.backgroundColor = n.is_read ? "#fff" : "#f0f8ff";
                }}
            >
